...
const SEED = {
  Contractor: [
    { name: "Sharma Constructions", city: "Mumbai", area: "Andheri West", specialization: "Civil Construction", specializations: ["Civil Construction"], rating: 4.8, experience: 18, experience_years: 18, projects: 142, completed_projects: 142, total_reviews: 45, verified: false, phone: "+91 XXXXX XXXXX", email: "hidden until verification", bio: "Full-service civil contractor specialising in turnkey villas and row houses." },
    { name: "Kumar Interiors", city: "Bengaluru", area: "Indiranagar", specialization: "Interior Design", specializations: ["Interior Design"], rating: 4.7, experience: 12, experience_years: 12, projects: 96, completed_projects: 96, total_reviews: 32, verified: false, phone: "+91 XXXXX XXXXX", email: "hidden until verification", bio: "Award-winning interior studio for apartments and duplex homes." },
    { name: "Naidu Builders", city: "Hyderabad", area: "Gachibowli", specialization: "Architecture", specializations: ["Architecture"], rating: 4.6, experience: 22, experience_years: 22, projects: 210, completed_projects: 210, total_reviews: 58, verified: false, phone: "+91 XXXXX XXXXX", email: "hidden until verification", bio: "Architect-led construction with an in-house structural team." },
    { name: "Iyer Homes", city: "Chennai", area: "Adyar", specialization: "Civil Construction", specializations: ["Civil Construction"], rating: 4.9, experience: 15, experience_years: 15, projects: 88, completed_projects: 88, total_reviews: 29, verified: false, phone: "+91 XXXXX XXXXX", email: "hidden until verification", bio: "Traditional and contemporary homes planned around Vaastu." },
    { name: "Reddy Electricals & Works", city: "Hyderabad", area: "Madhapur", specialization: "Electrical Work", specializations: ["Electrical Work"], rating: 4.4, experience: 9, experience_years: 9, projects: 130, completed_projects: 130, total_reviews: 21, verified: false, phone: "+91 XXXXX XXXXX", email: "hidden until verification", bio: "Complete wiring, panels and home-automation wiring." },
    { name: "Desai Plumbing Solutions", city: "Pune", area: "Kothrud", specialization: "Plumbing", specializations: ["Plumbing"], rating: 4.5, experience: 11, experience_years: 11, projects: 174, completed_projects: 174, total_reviews: 37, verified: false, phone: "+91 XXXXX XXXXX", email: "hidden until verification", bio: "Water supply, drainage and bathroom fitting specialists." },
    { name: "Ghosh Design Studio", city: "Kolkata", area: "Salt Lake", specialization: "Exterior Design", specializations: ["Exterior Design"], rating: 4.3, experience: 7, experience_years: 7, projects: 54, completed_projects: 54, total_reviews: 14, verified: false, phone: "+91 XXXXX XXXXX", email: "hidden until verification", bio: "Facades, terraces and landscape elevations." },
    { name: "Menon Contractors", city: "Kochi", area: "Kakkanad", specialization: "Civil Construction", specializations: ["Civil Construction"], rating: 4.6, experience: 16, experience_years: 16, projects: 121, completed_projects: 121, total_reviews: 41, verified: false, phone: "+91 XXXXX XXXXX", email: "hidden until verification", bio: "Quality-first builder for Kerala-style and modern homes." },
  ],
  Appointment: [
...
const TOPICS = [
  { re: /blueprint|floor plan|bhk|full house|plot|duplex|penthouse/, page: "BlueprintGenerator",
    reply: "For a full house, start with the Blueprint Generator: enter your BHK, plot size, floors and budget and it drafts a Vastu-aware 2D floor plan plus a 3D view of the elevation. Want me to take you there?" },
